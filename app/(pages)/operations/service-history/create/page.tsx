...
const CreateServiceRecordPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const response = await serviceHistoryApi.createServiceHistory(serviceData) as {
                success: boolean,
                message: string
            };
            if (response.success) {
                ...
                toast.error("Failed to add service record", {description: response.message});
            }
        } catch (err: unknown) {
    ...
    return (
        <div className="p-6 max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <Label>Vehicle</Label>
                    <Select onValueChange={(value) => setServiceData({...serviceData, vehicleId: value})}>
                        <SelectTrigger>
                ...
                <div>
                    ...
                    <Select onValueChange={(value) => setServiceData({...serviceData, mechanicId: value})}>
                        <SelectTrigger>
                ...
                <div>
                    <Label>Branch</Label>
                    <Select onValueChange={(value) => setServiceData({...serviceData, branchId: value})}>
                        <SelectTrigger>
                ...
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) => setServiceData({...serviceData, serviceDate: new Date(e.target.value)})}
                        required
                    />
                </div>
