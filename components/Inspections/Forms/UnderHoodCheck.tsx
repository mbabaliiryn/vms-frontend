...
const UnderHoodCheckForm: React.FC<UnderHoodCheckFormProps> = ({data, onChange}) => {
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    {renderCheck("Radiator Hoses & Clamps", "underHood.radiatorHosesClamps")}
                    {renderCheck("Battery Terminals & Cables", "underHood.batteryTerminalsCables")}
                ...
                <div className="space-y-6">
                    ...
                    {renderCheck("Ignition Coils & Wires", "underHood.ignitionCoilsWires")}
                    {renderCheck("Vacuum Pump Condition", "underHood.vacuumPumpCondition")}
                    {renderCheck("EGR System", "underHood.egrSystem")}
                    {renderCheck("PCV System", "underHood.pcvSystem")}
                    {renderCheck("Diesel System Inspection", "underHood.dieselSystemInspection")}
                </div>
            </div>
        </div>
    );
